    ...
    public class MyInitializer : CreateDatabaseIfNotExists<DatabaseContext>
    {
        protected override void Seed(DatabaseContext context)
        {
            ...
            Diet gazininDieti = new Diet()
            {
                ...
                Hastalik = "seker hastasi",
                Hikaye = "bisiklet sürüyor",
                Olcüm = "90-60-90",
                Tahlil ="ph degeri iyi",
                EkBilgiler ="ek bilgi",
                CreatedOn = DateTime.Now,
            ...
            Diet gulteninDieti = new Diet()
            {
                ...
                Description = "3 günlük diyet",
                Text = "sabah 1 ekmek öglen 2 ekmek akşam 3 ekmek",
                Hastalik = "akıl hastasi",
                Hikaye = "bisiklet sürüyor2",
                Olcüm = "30-60-30",
                Tahlil = "ph degeri kötü",
                EkBilgiler = "ek bilgi2",
                CreatedOn = DateTime.Now,
                ModifiedOn = DateTime.Now.AddMinutes(10),
                ModifiedUsername = "gazihandemir"
            };
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                Diet diet = new Diet()
                {
                    ...
                    Hikaye = $"{i}sürüyor2",
                    Olcüm = "${ i }-60-30",
                    Tahlil = $"{i}degeri kötü",
                    EkBilgiler = $"ek bilgi { i }",
                    CreatedOn = DateTime.Now,
                    ModifiedOn = DateTime.Now.AddMinutes(10),
                    ModifiedUsername = "gazihandemir"
                };
